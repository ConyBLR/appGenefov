...
from GenefovVersion2 import Genefov
...
class Ui_MainWindow(object):
        ...
        def calcular_generacion(self):
                ...
                '''     'Salta': {'latitud': -24, 'longitud': -65, 'altura': 1233, 'gtm': 0, 'cvptm': -0.36, 'PST': 450},
                        ...
                        'ero': {'latitud': -30, 'longitud': -70, 'altura': 1500, 'gtm': 0},
                ...
                try:
                        self.PST = float(self.lineEdit_4.text()) if self.lineEdit_4.text() else 450
                except ValueError:
                        self.PST = 450

                
                try:
                        self.cvptm = float(self.lineEdit_5.text()) if self.lineEdit_5.text() else -0.36
                except ValueError:
                        self.cvptm = -0.36

                
                try:
                        self.cantidad = float(self.lineEdit_7.text()) if self.lineEdit_7.text() else 1
                except ValueError:
                        self.cantidad = 1
                ...
                self.dias, self.vec_suma, total, s = genefov.diaria3
